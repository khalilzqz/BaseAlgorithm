...
public class Main {
	...
	static String datasetName = "D:/DataForMining/RidgeRegression/sin";
	...
	public static void DisplayInCSV(int features) {
		...
		/*
		 * for (int i = 0 ; i<poly_featurematrix.length;i++){ for (int j=0; j<
		 * features; j++){ System.out.print(poly_featurematrix[i][j]+","); }
		 * System.out.print(classvector[i]); System.out.println(); }
		 */
	}
	...
	public static void createData(int percent90, int inputtrainingdata, String datasetName) throws IOException {
		BufferedReader br = new BufferedReader(new FileReader(datasetName + ".csv"));
		String sCurrentLine;
