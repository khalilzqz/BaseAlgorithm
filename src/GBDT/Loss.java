...
public abstract class Loss {
	...
	public double get(ArrayList<Instance> data, double leftAddValue, double rightAddValue, int splitIndex) {
	...
	public abstract double getIncrement(ArrayList<Instance> data, int begin, int end);
