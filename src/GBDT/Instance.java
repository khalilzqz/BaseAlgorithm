...
public class Instance {
	...
	public static void saveDataset(ArrayList<Instance> s, double[] trueValues, String path) throws IOException {
		...
		int count_ins = 0;
		for (Instance ins : s) {
			w.write(ins.trueValue + "|" + trueValues[count_ins++]);
	...
	public static ArrayList<Instance> loadDatasetAndSchema(String file) throws Exception {
